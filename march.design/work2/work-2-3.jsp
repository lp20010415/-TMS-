...
<%
	...
	String tableName="data_jiaju_all_bad_1"; 
...
夹具情况		
	...
	已上报的报废夹具-data_jiaju_bad_1;-this
采购入库夹具
	申请入库夹具(填写信息)
		...
		<ul class="layui-nav layui-nav-tree layui-bg-blue" lay-filter="test" style="float:left;width:auto">
		  <li class="layui-nav-item layui-nav-itemed" >
		    ...
		    <dl style="background-color:#fff;" class="layui-nav-child layui-bg-blue">
		      ...
		      <dd><a href="work-2-3.jsp" class="layui-this">已上报的报废夹具</a></dd>
		    </dl>
		  </li>
		  <li class="layui-nav-item">
...
<div style="border:1px solid black;width:auto;float:right;margin:3px;margin-right:20px;">
	...
	<form name="form1" class="form" action="" method="post" id="form1" style="float:right;border:1px solid black;margin:2px;overflow:auto;white-space:nowarp;width:1020px;height:490px;background:white;">
				<nobr><a >夹具编号</a><a>名称</a><a>Family</a><a>Model</a><a>PartNo</a><a>生产日期</a><a>建档日期</a><a>采购单据号</a><a>经办人</a><a>库位</a><a>照片</a><a>状态</a><a style="border-right:1px solid black;">上报人</a><a>上报时间</a><a style="width:200px">报废原因</a><a>操作员</a><a>操作</a></nobr>
	    		<%
	    		int i = 0;
	    		int k = 0;
	    		while(rs.next()){ 
...
while(k>=1){%>	
function btn出库<%=k%>(){
		document.form1.action="出库.jsp";
		document.form1.submit();
	}
window.onload = function(){
	if(document.getElementById("zhuangtai<%=k%>").text == "请出库"){
		document.getElementById("chu<%=k%>").disabled=false;
	}else{
		document.getElementById("chu<%=k%>").disabled=true;
	}	
}
