...
<%
	...
	String tableName="data_jiaju_bad_1"; 
...
<!--
采购夹具
	已申请采购的夹具-data_jiaju_applied_1(通过,过二审-data_jiaju_applied_2(记录,一审提交时间,审核人)->data_jiaju_all_applied_2(同上);不同意,-data_jiaju_applied_disagree(记录不通过原因))
报废夹具
	已申请报废的夹具-data_jiaju_bad_1(确认无误,过二审-data_jiaju_bad_2->data_jiaju_all_bad_2(记录,审核时间和 审核人))-this
  ...
  <div class="layui-main">
    ...
    <ul class="layui-nav " >
      <li class="layui-nav-item layui-this">
        <a href="work-3-1.jsp" style="background-color: #f9e9c3;"><font color="black">操作界面</font></a> 
      </li>
	...
	<div style="">
		<ul class="layui-nav layui-nav-tree layui-bg-blue" lay-filter="test" style="float:left;width:auto">
		  <li class="layui-nav-item " >
		    <a href="javascript:;"><font color="black"><b>夹具申请</b></font></a>
		    <dl style="background-color:#fff;" class="layui-nav-child layui-bg-blue">
		      <dd><a href="work-3-1.jsp">已申请采购的夹具</a></dd>
		    </dl>
		  </li>
		  <li class="layui-nav-item layui-nav-itemed">
		    <a href="javascript:;"><font color="black"><b>报废夹具申请 </b></font></a>
		    <dl class="layui-nav-child">
		      <dd><a href="work-3-2.jsp" class="layui-this" >已申请报废的夹具</a></dd>
		    </dl>
		  </li>
...
<div style="border:1px solid black;width:auto;float:right;margin:3px;margin-right:20px;">
	<div style="height:30px;display:block;border:1px solid black;margin:2px;">
		<form style="height:20px;margin-top:5px;float:right;" method="post" action="查询3.jsp">
	...
	<form name="form1" class="form" action="" method="post" id="form1" style="float:right;border:1px solid black;margin:2px;overflow:auto;white-space:nowarp;width:1020px;height:490px;background:white;">
				<nobr><a >夹具编号</a><a>名称</a><a>Family</a><a>Model</a><a>PartNo</a><a>生产日期</a><a>建档日期</a><a>采购单据号</a><a>经办人</a><a>库位</a><a>照片</a><a>状态</a><a style="border-right:1px solid black;">上报人</a><a>上报时间</a><a style="width:200px;">报废原因</a><a>审核人</a><a>操作</a></nobr>
	    		<%
	    		int i = 0;
	    		int k = 0;
	    		while(rs.next()){ 
...
while(k>=1){%>	
function btn确认无误<%=k%>(){
		document.form1.action="确认无误2.jsp";
