...
报废夹具
	已申请报废的夹具-data_jiaju_bad_1(确认无误,过二审-data_jiaju_bad_2->data_jiaju_all_bad_2(记录,审核时间和 审核人))
		...
		<ul class="layui-nav layui-nav-tree layui-bg-blue" lay-filter="test" style="float:left;width:auto">
		  <li class="layui-nav-item layui-nav-itemed" >
		    ...
		    <dl style="background-color:#fff;" class="layui-nav-child layui-bg-blue">
		      <dd><a href="work-3-1.jsp" class="layui-this">已申请采购的夹具</a></dd>
		    </dl>
		  </li>
		  <li class="layui-nav-item">
		    <a href="javascript:;"><font color="black"><b>报废夹具申请 </b></font></a>
		    <dl class="layui-nav-child">
		      <dd><a href="work-3-2.jsp" >已申请报废的夹具</a></dd>
		    </dl>
		  </li>
