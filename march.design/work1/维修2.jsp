...
String date = df.format(new Date());%> 
   ...
   //驱动程序名 
     ...
     if(borrower != null){
	     ps.addBatch("INSERT INTO data_jiaju_repair (状态,照片,库位,经办人,采购单据号,建档日期,生产日期,PartNo,Model,Family,名称,夹具编号) SELECT 状态,照片,库位,经办人,采购单据号,建档日期,生产日期,PartNo,Model,Family,名称,夹具编号 FROM data_jiaju_borrowed WHERE 夹具编号='"+bianhao+"'");
