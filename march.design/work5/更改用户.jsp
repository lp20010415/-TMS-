...
%> 
   ...
   //驱动程序名 
     ...
     while(i>=1){
     	...
     	String test3 = request.getParameter("id"+i);
     	String test4 = request.getParameter("password"+i);
     	String test5 = request.getParameter("users"+i);
     	if(test != "" && test2 !=""){
     		users = test5;
     		password = test4;
     		id = test3;
     ...
     if(useman != null && deleteNo == "999"){
	     ps.addBatch("update user set id='"+id+"',password='"+password+"',users='"+users+"',useman='"+useman+"' where useman='"+useman+"'");     
	     ps.executeBatch();
	     message="更改成功!";
     }else{
    	 message="更改失败,更改码错误或未填写";
     }
